...
# File: sim_tb_fir_generic.tcl
# Description: Simulation launch script for tb_fir_generic.sv
#              testbench.
# 
...
create_wave_config tb_fir_generic.wcfg

# Probe all signals recursively
add_wave -recursive tb_fir_generic
...
set result_file [file join $script_directory "result_fir_filter.txt"]
