...
# File: sim_tb_safe_mult.tcl
# Description: Simulation launch script for tb_safe_mult.sv
#              testbench.
# 
...
create_wave_config tb_safe_mult.wcfg

# Probe all signals recursively
add_wave -recursive tb_safe_mult
...
set result_file [file join $script_directory "result_mult.txt"]
